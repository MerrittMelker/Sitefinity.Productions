...
{
    public class ProductionsModuleStorageMetadataSource : SitefinityMetadataSourceBase
    {
        #region Construction
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductionsModuleStorageMetadataSource" /> class.
        /// </summary>
        public ProductionsModuleStorageMetadataSource()
            : base(null)
        {
        }
        ...
        public ProductionsModuleStorageMetadataSource(IDatabaseMappingContext context)
            : base(context)
        {
        }
        #endregion
        ...
        protected override IList<IOpenAccessFluentMapping> BuildCustomMappings()
        {
            ...
            sitefinityMappings.Add(new ProductionsModuleFluentMapping(this.Context));
